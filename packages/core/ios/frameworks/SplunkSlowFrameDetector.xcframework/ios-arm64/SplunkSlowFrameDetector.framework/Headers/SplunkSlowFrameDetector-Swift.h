...
#ifndef SPLUNKSLOWFRAMEDETECTOR_SWIFT_H
#define SPLUNKSLOWFRAMEDETECTOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SplunkSlowFrameDetector",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>DisplayLinkTicker</code> for frame monitoring and an <code>OTelDestination</code> for reporting.
