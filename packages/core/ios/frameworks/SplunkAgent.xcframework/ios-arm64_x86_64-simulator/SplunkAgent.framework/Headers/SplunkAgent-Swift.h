...
#ifndef SPLUNKAGENT_SWIFT_H
#define SPLUNKAGENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SplunkAgent",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
SWIFT_CLASS("_TtC11SplunkAgent20SplunkAgentResources")
@interface SplunkAgentResources : NSObject
