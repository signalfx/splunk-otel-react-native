...
#ifndef SPLUNKWEBVIEW_SWIFT_H
#define SPLUNKWEBVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SplunkWebView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
SWIFT_CLASS("_TtC13SplunkWebView22SplunkWebViewResources")
@interface SplunkWebViewResources : NSObject
...
/// Provides the ability to inject a JavaScript bridge into <code>WKWebView</code> instances for Browser RUM correlation.
SWIFT_CLASS("_TtC13SplunkWebView22WebViewInstrumentation")
@interface WebViewInstrumentation : NSObject
/// Initializes the <code>WebViewInstrumentation</code> module.
...
@interface WebViewInstrumentation (SWIFT_EXTENSION(SplunkWebView)) <WKScriptMessageHandler>
- (void)userContentController:(WKUserContentController * _Nonnull)_ didReceiveScriptMessage:(WKScriptMessage * _Nonnull)_;
@end
