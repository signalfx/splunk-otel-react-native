...
#ifndef SPLUNKNETWORK_SWIFT_H
#define SPLUNKNETWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SplunkNetwork",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface NSURLSessionTask (SWIFT_EXTENSION(SplunkNetwork))
- (void)splunkSwizzledSetStateWithState:(enum NSURLSessionTaskState)state;
- (void)splunkSwizzledResume;
@end
