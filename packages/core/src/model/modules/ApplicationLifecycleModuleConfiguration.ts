 ...
 */
export class ApplicationLifecycleModuleConfiguration extends ModuleConfiguration {
  /**
   * @param isEnabled - Whether lifecycle tracking is enabled. Defaults to `true`.
   */
  constructor(public isEnabled: boolean = true) {
    super();
  }

  readonly name = 'applicationLifecycle';
