...
import static com.splunkotelreactnative.LogConstants.LOG_TAG;

import android.app.Application;
import android.content.ContextWrapper;
import android.util.Log;

import com.splunkotelreactnative.CustomZipkinEncoder;
...
/**
 * Copied from splunk-otel-android.
...
class ZipkinWriteToDiskExporterFactory {
  ...
  static ZipkinSpanExporter create(ContextWrapper application, int maxUsageMegabytes) {
